 ...
 */
#define C_Error_CUSTOM_START ((1 << 31) + (1 << 30))
 ...
 */
#define C_Error_INTERNAL_START (1 << 31)
 ...
 */
void token_preimage_destroy(struct C_TokenPreimage *t);

/**
 * Return base64 encoding as a C string.
 */
char *token_preimage_encode_base64(const struct C_TokenPreimage *t);
 ...
 */
struct C_TokenPreimage *token_preimage_decode_base64(const uint8_t *s, uintptr_t s_length);
 ...
 * done with it.
 */
struct C_Token *token_random(void);

/**
 * Destroy a `Token` once you are done with it.
 */
void token_destroy(struct C_Token *token);
 ...
 */
struct C_BlindedToken *token_blind(const struct C_Token *token);

/**
 * Return base64 encoding as a C string.
 */
char *token_encode_base64(const struct C_Token *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_Token *token_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy a `BlindedToken` once you are done with it.
 */
void blinded_token_destroy(struct C_BlindedToken *token);

/**
 * Return base64 encoding as a C string.
 */
char *blinded_token_encode_base64(const struct C_BlindedToken *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_BlindedToken *blinded_token_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy a `SignedToken` once you are done with it.
 */
void signed_token_destroy(struct C_SignedToken *token);

/**
 * Return base64 encoding as a C string.
 */
char *signed_token_encode_base64(const struct C_SignedToken *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_SignedToken *signed_token_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy an `UnblindedToken` once you are done with it.
 */
void unblinded_token_destroy(struct C_UnblindedToken *token);
 ...
 * destroy the `BlindedToken` once you are done with it!
 */
struct C_TokenPreimage *unblinded_token_preimage(const struct C_UnblindedToken *token);

/**
 * Return base64 encoding as a C string.
 */
char *unblinded_token_encode_base64(const struct C_UnblindedToken *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_UnblindedToken *unblinded_token_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy a `VerificationKey` once you are done with it.
 */
void verification_key_destroy(struct C_VerificationKey *key);
 ...
 */
struct C_VerificationSignature *verification_key_sign_sha512(const struct C_VerificationKey *key,
 ...
 */
int verification_key_invalid_sha512(const struct C_VerificationKey *key,
                                    const struct C_VerificationSignature *sig,
                                    const uint8_t *message,
                                    uintptr_t message_length);
 ...
 */
void verification_signature_destroy(struct C_VerificationSignature *sig);

/**
 * Return base64 encoding as a C string.
 */
char *verification_signature_encode_base64(const struct C_VerificationSignature *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_VerificationSignature *verification_signature_decode_base64(const uint8_t *s,
                                                                     uintptr_t s_length);
 ...
 * done with it.
 */
struct C_SigningKey *signing_key_random(void);
 ...
 */
struct C_SigningKey *signing_key_from_random_bytes(const uint8_t *bytes, uintptr_t bytes_length);

/**
 * Destroy a `SigningKey` once you are done with it.
 */
void signing_key_destroy(struct C_SigningKey *key);
 ...
 */
struct C_SignedToken *signing_key_sign(const struct C_SigningKey *key,
                                       const struct C_BlindedToken *token);
 ...
 */
struct C_PublicKey *signing_key_get_public_key(const struct C_SigningKey *key);

/**
 * Return base64 encoding as a C string.
 */
char *signing_key_encode_base64(const struct C_SigningKey *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_SigningKey *signing_key_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy a `DLEQProof` once you are done with it.
 */
void dleq_proof_destroy(struct C_DLEQProof *p);

/**
 * Return base64 encoding as a C string.
 */
char *dleq_proof_encode_base64(const struct C_DLEQProof *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_DLEQProof *dleq_proof_decode_base64(const uint8_t *s, uintptr_t s_length);
 ...
 */
struct C_DLEQProof *dleq_proof_new(const struct C_BlindedToken *blinded_token,
                                   const struct C_SignedToken *signed_token,
                                   const struct C_SigningKey *key);
 ...
 */
int dleq_proof_invalid(const struct C_DLEQProof *proof,
                       const struct C_BlindedToken *blinded_token,
                       const struct C_SignedToken *signed_token,
                       const struct C_PublicKey *public_key);

/**
 * Destroy a `PublicKey` once you are done with it.
 */
void public_key_destroy(struct C_PublicKey *k);

/**
 * Return base64 encoding as a C string.
 */
char *public_key_encode_base64(const struct C_PublicKey *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_PublicKey *public_key_decode_base64(const uint8_t *s, uintptr_t s_length);

/**
 * Destroy a `BatchDLEQProof` once you are done with it.
 */
void batch_dleq_proof_destroy(struct C_BatchDLEQProof *p);

/**
 * Return base64 encoding as a C string.
 */
char *batch_dleq_proof_encode_base64(const struct C_BatchDLEQProof *t);
 ...
 * destroy the returned pointer once you are done with it!
 */
struct C_BatchDLEQProof *batch_dleq_proof_decode_base64(const uint8_t *s, uintptr_t s_length);
 ...
 */
struct C_BatchDLEQProof *batch_dleq_proof_new(const struct C_BlindedToken *const *blinded_tokens,
                                              const struct C_SignedToken *const *signed_tokens,
                                              int tokens_length,
                                              const struct C_SigningKey *key);
 ...
 * the proof is invalid and false (zero) when valid
 */
int batch_dleq_proof_invalid(const struct C_BatchDLEQProof *proof,
                             const struct C_BlindedToken *const *blinded_tokens,
                             const struct C_SignedToken *const *signed_tokens,
                             int tokens_length,
                             const struct C_PublicKey *public_key);
 ...
 * the proof is invalid and false (zero) when valid
 */
int batch_dleq_proof_invalid_or_unblind(const struct C_BatchDLEQProof *proof,
                                        const struct C_Token *const *tokens,
                                        const struct C_BlindedToken *const *blinded_tokens,
                                        const struct C_SignedToken *const *signed_tokens,
                                        struct C_UnblindedToken **unblinded_tokens,
                                        int tokens_length,
                                        const struct C_PublicKey *public_key);
